        ...
        <Row>
          <Col md={8} className="home-about-description">
            ...
            <p className="home-about-body">
              ...
              <br />
              <br />My programming superpowers are
              <i>
                <b className="purple"> JavaScript, TypeScript, Flutter (Dart), Solidity, and Rust. </b>
              </i>
              <br />
              <br />
              ...
              <br />
              <br />
              I also love LowCode technolgies and build with 
          
               <b className="purple">Power Apps, Webflow</b> and
              <i>
                <b className="purple">
                  {" "}
                  carry out automation with Power Automate.
                </b>
              </i>
        ...
        <Row>
          <Col md={12} className="home-about-social">
            ...
            <ul className="home-about-social-links">
              ...
              <li className="social-icons">
                <a
                  href="https://www.instagram.com/adino.dev/"
                  target="_blank"
                  rel="noreferrer"
                  className="icon-colour home-social-icons"
                >
